const apps = [
  ...
  },
  {
    title: "ToSBot",
    description:
      "A chrome extension that summarizes Terms of Service documents by implementing an ML model.",
  ...
  },
  {
    title: "Tracker",
    description:
      "A web app I developed to help users quickly create and manage charts. Users can quickly create projects and view the data with their choice of four graph styles: Bar, Pie, Polar, and line.",
  ...
  },
  {
    title: "Game Board",
    description:
      "A simple Tic Tac Toe game where users can play in a local match or against the computer. Currently, the game only has one level. Using the Minimax algorithm the computer is sure to win or tie. Don't belive me? Try it yourself!",
  ...
  },
  {
    title: "E-commerce",
    description:
      "A tech e-commerce site I developed. I used this project to expand on my web development knowledge. I mainly focused on the user experience, by creating visually appealing animations.",
    technologies: "NodeJS | MongoDB | ReactJS",
  ...
  },
  {
    title: "High or Low",
    description:
      ' Web version of a the card game "Higher or Lower". Users can create rooms, and play versus their friends live.',
